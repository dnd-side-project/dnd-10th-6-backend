...
class BestWorthDashboardComponentTest {
    ...
    void convertStatisticsToDashboardComponentDto() {
        ...
        // when
        BestWorthDashboardComponent bestWorthDashboardComponent = new BestWorthDashboardComponent(List.of(statistic));

        // then
        int expectedOpt1Percentage = 60;
        int expectedOpt2Percentage = 40;
        assertThat(bestWorthDashboardComponent.getRank().stream().mapToInt(RatioDto::getPercentage))
