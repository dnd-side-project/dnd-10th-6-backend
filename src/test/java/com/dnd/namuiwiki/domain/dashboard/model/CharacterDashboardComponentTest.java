...
class CharacterDashboardComponentTest {
    ...
    void convertStatisticsToDashboardComponentDto() {
        ...
        // when
        CharacterDashboardComponent characterDashboardComponent = new CharacterDashboardComponent(List.of(statistic1, statistic2));

        // then
        boolean statistic1Result = true;
        boolean statistic2Result = false;
        assertThat(characterDashboardComponent.getCharacters().stream().map(CharacterDashboardComponent.Character::isValue))
